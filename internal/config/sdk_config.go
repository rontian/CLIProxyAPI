...
type SDKConfig struct {
	...
	// AutoRouter configures client-visible "auto" models that route requests to role-specific models.
	AutoRouter AutoRouterConfig `yaml:"auto-router" json:"auto-router"`
